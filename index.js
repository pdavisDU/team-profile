...
const emplyQues = [
    ...
    {
        message: (input)=> `What is ${input.name} ID`,
        name: 'Id',
        type: 'input',
    },
    {
        message: (input)=> `What is ${input.name} Email`,
        name: 'Email',
        type: 'input',
    },
    {
        message: (input)=> {
            if (input.role === 'Engineer') {
                return `What is ${input.name} Github username`;
            } else {
                return `What school did ${input.name} go/goes to`;
            }
        },
        name: 'other',
        type: 'input',
    ...
    <!DOCTYPE html>
        <html lang="en">
          <head>
            ...
            ${teams.map(Employee => Employee.createHTML(Employee.officeNumber || Employee.github || Employee.school)).join("\n")}
            </div>
            </main>
            </body>
            </html>
